    ...
    >
      ...
      <div className="relative p-5 flex flex-col flex-1 gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {!isOwner && creatorName && (
            <span className="text-[9px] font-black px-2 py-0.5 rounded-full bg-white/10 text-white/80 border border-white/10 uppercase tracking-wide flex items-center gap-1">
